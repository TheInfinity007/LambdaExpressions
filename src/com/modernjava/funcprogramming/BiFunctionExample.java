...
public class BiFunctionExample {
	...
	public static void main(String[] args) {
		// Bifunction 2 inputs List<Instructor>, and second is predicate which will filter if instructor has online courses and return a map of <String, Integer>, where string is the  name and integer is the years of experience
